  ...
  <tbody>
    ...
    <tr>
      ...
      <td>expected2</td>
        ...
        <tr>
      <td rowspan="2">[3](https://trbl-workshop.cszevaco.com/workshop/exercise_03)</td>
      <td rowspan="2">The pod fails to start due to tight CPU and memory quotas in the namespace. Limits and requests must be tuned, but eventually, the deployment must be scaled down to one replica to fit within the quotas.</td>
      <td>context1</td>
      <td>prompt1</td>
      <td>expected1</td>
    </tr>
    <tr>
      ...
      <td>Result2</td>
        ...
        <tr>
      <td rowspan="2">[4](https://trbl-workshop.cszevaco.com/workshop/exercise_04)</td>
      <td rowspan="2">The route is unavailable due to two misconfigurations in the service: an incorrect pod selector and an invalid port mapping.</td>
      <td>context1</td>
      <td>prompt1</td>
      <td>expected1</td>
    </tr>
    ...
    <tr>
      ...
      <td>Result2</td>
        ...
        <tr>
      <td rowspan="2">[6](https://trbl-workshop.cszevaco.com/workshop/exercise_06)</td>
      <td rowspan="2">A namespace is stuck in terminating state due to lingering finalizers that have not been cleared.</td>
      <td>context1</td>
      <td>prompt1</td>
      <td>expected1</td>
    </tr>
