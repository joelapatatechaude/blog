...
<table class="table-auto">
  ...
  <tbody>
    <tr>
      ...
      <td style={{ backgroundColor: 'lightgreen' }}>The answer suggest to edit the yaml file (via the oc edit command). The very impressive bit is that it says "Assuming the correct image name is quay.io/rh_ee_cschmitz/pacma**n**:latest". Yes, it infered the correct name, very impressive.</td>
