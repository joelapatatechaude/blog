...
spec:
  config:
    ...
    storage:
      files:
      - contents:
          source: data:text/plain;charset=utf-8;base64,
        mode: 0755
...
#!/bin/bash
if [ "$2" = "up" ]; then
  ip route add 10.0.0.0/16 via 192.168.6.1 dev br-ex 2>/dev/null || true
